        ...
        html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e5e7eb; border-radius: 12px; overflow: hidden;">
                ...
                <div style="padding: 40px; background-color: #ffffff;">
                    ...
                    <br>
                    <a href="http://localhost:8000/blog/all" style="display: inline-block; background-color: #4f46e5; color: #ffffff; text-decoration: none; padding: 12px 24px; border-radius: 6px; font-weight: bold;">Start Reading</a>
                </div>
